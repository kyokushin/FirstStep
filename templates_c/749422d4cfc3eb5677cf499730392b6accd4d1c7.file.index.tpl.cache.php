<?php /* Smarty version Smarty-3.1.8, created on 2012-04-04 15:22:33
         compiled from ".\templates\index.tpl" */ ?>
<?php /*%%SmartyHeaderCode:251924f7c6739beb238-36899499%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_4f7c6739d2fff7_68085720',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_4f7c6739d2fff7_68085720')) {function content_4f7c6739d2fff7_68085720($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_capitalize')) include 'C:\\php\\libs\\plugins\\modifier.capitalize.php';
if (!is_callable('smarty_modifier_date_format')) include 'C:\\php\\libs\\plugins\\modifier.date_format.php';
if (!is_callable('smarty_function_html_select_date')) include 'C:\\php\\libs\\plugins\\function.html_select_date.php';
if (!is_callable('smarty_function_html_select_time')) include 'C:\\php\\libs\\plugins\\function.html_select_time.php';
if (!is_callable('smarty_function_html_options')) include 'C:\\php\\libs\\plugins\\function.html_options.php';
...
The value of {$Name} is <b><?php echo '/*%%SmartyNocache:251924f7c6739beb238-36899499%%*/<?php echo $_smarty_tpl->tpl_vars[\'Name\']->value;?>
/*/%%SmartyNocache:251924f7c6739beb238-36899499%%*/';?>
</b>

variable modifier example of {$Name|upper}

<b><?php echo '/*%%SmartyNocache:251924f7c6739beb238-36899499%%*/<?php echo strtoupper($_smarty_tpl->tpl_vars[\'Name\']->value);?>
/*/%%SmartyNocache:251924f7c6739beb238-36899499%%*/';?>
</b>
